        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-[#f7fafb] rounded-xl shadow-md p-8 mb-8 overflow-x-auto">
            ...
            <section className="mb-8">
              ...
              <p>
                Outceedo.com, registered in Scotland, United Kingdom
            ...
            <section className="mb-8">
              ...
              <p>
                ...
                <br />
                If the player is a minor then it must be a responsibility of the
            ...
            <section className="mb-8">
              ...
              <h3 className="font-bold">You Should:</h3>
              <ul className="list-disc pl-5">
                <li>be aged 18 years or older</li>
                <li>register your account on the website/mobile app</li>
                <li>
                  fill the personal profile with complete and accurate personal
                  details
                </li>
                <li>
                ...
                <li>
                  agree for ceasing of your account without notice, if you are
                  not complying with our policies and identified as fraud.
                </li>
              </ul>
              <h3 className="font-bold mt-4">You Should Not:</h3>
              <ul className="list-disc pl-5">
                <li>
                  use our website, mobile app and services if you are not above
                  18 years of age
                </li>
                <li>
                ...
                <li>
                  uploading the content that infringe the copyright, trademark
                ...
                <li>
                  ...
                  of our Services or impose an unreasonable or
                ...
                <li>
                  collect information about users such as personal data, privacy
                  data, phone numbers, addresses, email addresses without our
                  consent
                </li>
                <li>
              ...
              <p>
                ...
                including minor players, you represent and warrant that you have
                the permission of the parent or legal guardian of all minor
                players. You represent and warrant that you (i) have never been
                the subject of a complaint, restraining order, or any other
                legal action involving criminal activity or alleged criminal
                activity, and you have not been arrested for, charged with, or
                convicted of any crime, or any criminal offence involving
                violence, abuse, neglect, fraud or larceny, or any offence that
                involves endangering the safety of others, and (ii) have not
                been and are not currently required to register as a sex
                offender with any government entity. Individuals who have been
                involved with activities described in “(i)” or “(ii)” above are
                NOT eligible to participate in our Services or to be or become
                Members.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <section className="mb-6">
                ...
                <ul className="list-disc pl-5">
                  <li>
                    Debit/Credit Cards using our third party (Stripe) payment
                    gateway
                  </li>
                ...
                <p>
                  ...
                  outceedo.com disclaims all liabilities in relation to your
                  payment processing by third party payment gateway service
                  ...
                  outceedo.com, you will be required to accept the terms of use
            ...
            <section className="mb-8">
              ...
              <p>
                {/* Full text from your document here */}
                YOU AGREE TO INDEMNIFY, DEFEND AND HOLD OUTCEEDO.COM, ITS PARENT
                COMPANIES, SUBSIDIARIES, OUR OFFICERS, DIRECTORS, SHAREHOLDERS,
                MANAGERS, EMPLOYEES, AFFILIATES AND AGENTS HARMLESS FROM AND
                AGAINST ALL ALLEGATIONS, LIABILITIES, ACTIONS, SUITS, LOSSES,
                DEMANDS, DAMAGES, FINES, PENALITIES, CLAIMS, OBLIGATIONS,
                SETTLEMENTS, JUDGEMENTS, COSTS AND EXPENSES (INCLUDING WITHOUT
                LIMITATION REASONABLE LEGAL FEES) ARISING OUT OF, RESULTING
                FROM, OR IN CONNECTION WITH THE SERVICES CONTEMPLATED BY THIS
                AGREEMENT AND ALSO RELATED TO YOUR BREACH OF THESE TERMS OF USE
                (INCLUDING, BUT NOT LIMITED TO, ANY BREACH BY PERSONS ACTING ON
                YOUR BEHALF WHO ACCESS THIS SITE USING WEBSITE ACCESS
                INFORMATION AND/OR BOOKING/PURCHASE DATA THAT YOU HAVE PROVIDED
                TO THEM).
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p>
                WE, AND OUR AFFILIATES, OFFICERS, DIRECTORS, EMPLOYEES, AGENTS,
                SUPPLIERS, MAKE NO WARRANTIES OR REPRESENTATIONS ABOUT THE
                CONTENT (INCLUDING THE USER CONTENT) AND SERVICES, INCLUDING BUT
                NOT LIMITED TO ITS ACCURACY, COMPLETENESS, TIMELINESS, OR
                RELIABILITY. WE SHALL NOT BE SUBJECT TO LIABILITY FOR TRUTH,
                ACCURACY, OR COMPLETENESS OF ANY INFORMATION CONVEYED TO THE
                ...
                WHATEVER CAUSE. YOU AGREE THAT YOU USE THE WEBSITE/MOBILE APP
                AND THE CONTENT AT YOUR OWN RISK. THE USER CONTENT IS
                CREATED/PUBLISHED BY REGISTERED MEMBERS. ANY VIEWS EXPRESSED ARE
                THEIRS AND UNLESS SPECIFICALLY STATED ARE NOT THOSE OF
                OUTCEEDO.COM. OUTCEEDO.COM IS NOT RESPONSIBLE FOR ANY CONTENT
                POSTED BY REGISTERED MEMBERS ON OUR WEBSITE/MOBILE APP OF FOR
                THE AVAILABILITY OR CONTENT OF ANY THIRD-PARTY SITES THAT ARE
                ...
                AT YOUR OWN RISK. WE DO NOT WARRANT THAT THE WEBSITE/MOBILE APP
                WILL OPERATE ERROR FREE OR THAT THIS WEBSITE/MOBILE APP, ITS
                SERVER, OR THE CONTENT IS FREE OF COMPUTER VIRUSES OR SIMILAR
                CONTAMINATION OR DESTRUCTIVE FEATURES. IF YOUR USE OF THE
                WEBSITE/MOBILE APP OR THE CONTENT RESULTS IN THE NEED FOR
                ...
                WARRANTIES OF ANY KIND. WE HEREBY DISCLAIM ALL WARRANTIES,
            ...
            <section className="mb-8">
              ...
              <p>
                Outceedo Limited
                <br />
                82 Berryden Gardens, Aberdeen,
                <br />
                United Kingdom, AB25 3RW
                <br />
                Registration No. SC853014
                <br />
                Web: outceedo.com
                <br />
                Email: info@outceedo.com
              </p>
            </section>
          </div>
        </div>
