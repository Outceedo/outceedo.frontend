          ...
          >
            ...
            <Section title="Cookies, Web Beacons & Similar Technologies">
              ...
              <ul className="list-none space-y-3">
                <li className="bg-white rounded-xl p-4 border border-gray-100">
                  <span className="font-bold text-gray-900">Cookies</span> –
                  tiny text files (typically made up of letters and numbers)
                  placed in the memory of your browser or device when you visit
                  a website or view a message. Cookies allow a website to
                  recognise a particular device or browser. There are several
                  types of cookies:
                ...
                <li className="bg-white rounded-xl p-4 border border-gray-100">
                  <span className="font-bold text-gray-900">Web beacons</span> –
                  Small graphic images (also known as "pixel tags" or "clear
                  GIFs") that may be included on our sites, services,
                ...
                <li className="bg-white rounded-xl p-4 border border-gray-100">
                  ...
                  device utilising local shared objects or local storage, such
                  as flash cookies, HTML 5 cookies, and other web application
                  software methods. These technologies can operate across all of
                  your browsers, and in some instances may not be fully managed
                  by your browser and may require management directly through
                  your installed applications or device. We do not use these
                  technologies for storing information to target advertising to
                  you on or off our sites.
                </li>
              </ul>
              <p>
              ...
              <div className="space-y-4">
                <div className="bg-white rounded-xl p-4 border border-gray-100">
                  ...
                  <p className="mt-4 text-gray-500">
                    ...
                    As we don't want you to be inundated with marketing mail
                    from the providers/partners, wherever possible our
                    technology will automatically opt you out of receiving their
                    marketing material. You should therefore not receive any
                    communication from any third parties, other than outlined in
                    this Privacy Policy. Although we cannot guarantee this, we
                    do have contractual arrangements in place to prevent such
            ...
            <Section title="Disclosure of Your Information">
                ...
                <li>
                  ...
                  <ul className="list-disc pl-6 mt-2 space-y-1">
                    ...
                    <li>
                      ...
                      to our advertisers, but we will provide them with
                      aggregate information about our users (for example, we may
                      inform them that 500 men aged under 30 have clicked on
                      their advertisement on any given day). We may also use
                      such aggregate information to help advertisers reach the
                      kind of audience they want to target (for example, women
                      in SW1). We may make use of the personal data we have
                      collected from you to enable us to comply with our
                      advertisers' wishes by displaying their advertisement to
                    ...
                    <li>
                      ...
                      your credit score where this is a condition of us entering
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>
                  If outceedo.com or substantially all of its assets are
                ...
                <li>
                  ...
                  safety of outceedo.com/Outceedo Limited, our customers, or
            ...
            <Section title="Your Rights">
              ...
              <div className="bg-red-50 rounded-xl p-4 border border-red-100">
                ...
                the Act. Any premium access request (players) will be subject to
                a fee of £10 to meet our costs in providing you with details of
            ...
            <Section title="Confidentiality">
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>
                  ...
                  that outceedo.com and its subsidiaries are not responsible for
                  evaluating the risks associated with the use of the website.
                </li>
              </ul>
            </Section>
