...
const paginatedBookings = bookings.slice(
 ...
 useEffect(() => {
  ...
  <Table className="min-w-[800px]">
          <TableHeader className="bg-red-50 text-xl">
            <TableRow>
              ...
              <TableHead className="px-4 py-3">Player's Name </TableHead>
              <TableHead className="px-4 py-3">Expert's Name</TableHead>
              <TableHead className="px-4 py-3">Booking Type</TableHead>
              <TableHead className="px-4 py-3">Booking Fee's</TableHead>
  ...
  <div>
    Showing {Math.min((currentPage - 1) * pageSize + 1, bookings.length)}–{Math.min(currentPage * pageSize, bookings.length)} out of {bookings.length}
  </div>
