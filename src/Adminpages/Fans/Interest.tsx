...
const Interests = () => {
  ...
  return (
    <div className="p-10 sm:p-8 w-full mx-auto bg-white rounded-xl shadow-md">
        ...
        <table className="min-w-full text-sm">
          <thead>
            <tr className="bg-red-100 text-left text-gray-700 font-semibold">
              <th className="p-3">
                <Checkbox
                  checked={selected.length === interestsData.length}
            ...
            {paginated.map((item) => (
              ...
              >
                ...
                <td className="p-3">
                  ...
                  <span className="text-gray-600">{item.follows}</span>
                </td>
