...
const totalPages = Math.ceil(awardsandcertificate.length / pageSize);
const paginatedawardsandcertificate = awardsandcertificate.slice(
  ...
  return (
    <div className="p-6">
      <div className="flex flex-col gap-2 sm:flex-row sm:players-center sm:justify-between mb-6">
        <h2 className="text-2xl font-semibold">Affiliations/Awards & Certificates</h2>
           </div>
 ...
 <div className="flex flex-col sm:flex-row players-center justify-between mt-4 gap-2 text-sm text-gray-500 dark:text-white">
  <div className="text-center sm:text-left w-full sm:w-auto">
    Showing {Math.min((currentPage - 1) * pageSize + 1, awardsandcertificate.length)}–
    {Math.min(currentPage * pageSize, awardsandcertificate.length)} out of {awardsandcertificate.length}
  </div>
...
export default AwardsandCertificate;