...
interface ExpertReviewsProps {
  expertData?: any; // The full expert data object
}

const ExpertReviews: React.FC<ExpertReviewsProps> = ({ expertData }) => {
  ...
  const useDynamicReviews =
    expertData &&
    expertData.reviewsReceived &&
    Array.isArray(expertData.reviewsReceived) &&
    expertData.reviewsReceived.length > 0;

  const dynamicReviews = useDynamicReviews ? expertData.reviewsReceived : [];
  ...
  return (
    <div className="p-4 -mt-10 w-full">
      ...
      <div className="grid md:grid-cols-3 gap-6 mt-6">
        {useDynamicReviews ? (
          // Dynamic reviews from expertData
