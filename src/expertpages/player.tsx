        ...
        <main className="flex-1 p-6 dark:bg-gray-900">
          ...
          <div className="bg-white shadow-lg rounded-lg p-10 mt-10 dark:bg-gray-800 dark:text-white">
            <div className="flex items-center">
              ...
              />
              <div className="ml-4">
                <h2 className="text-xl font-Raleway font-semibold">
                  Rohan Roshan
                </h2>
                <p className="text-gray-500 font-Opensans dark:text-gray-400">
                  Age 14 | 166cm | 45kg | London, England
                </p>
              </div>
            </div>
              ...
              <div className="flex justify-center gap-5">
                <div className="text-left mb-6">
                  <h2 className="text-3xl font-bold mr-28 mt-5 text-gray-800 dark:text-white">
                    <span className="block font-light text-4xl">{OVR}%</span>{" "}
                    {/* Percentage on top */}
                    <span className="text-xl font-Raleway "> OVR </span>{" "}
                    {/* OVR text below */}
                  </h2>
                </div>
                {stats.map((stat, index) => (
                  ...
                  >
                    ...
                    <p className="text-sm font-bold text-gray-700 font-Raleway dark:text-white">
                      {stat.label}
                    </p>
                  </div>
                ))}
            ...
            <div className="mt-4 relative border p-4 rounded-lg dark:bg-gray-700 dark:text-white">
              ...
              <p>
                ...
                Laboriosam adipisci omnis corporis architecto placeat vel
                asperiores nostrum non blanditiis, praesentium, voluptatem
                officiis rerum vitae in veritatis quo temporibus, accusantium
                sequi.
              </p>
            </div>
            ...
            <div className="mt-4 grid grid-cols-2 gap-4">
              <div className="relative border p-4 rounded-lg dark:bg-gray-700">
                ...
                <p>
                  ...
                  dolores sed, ullam quis non magnam? Sapiente{" "}
                </p>
              </div>
              ...
              <div className="relative border p-4 rounded-lg dark:bg-gray-700">
                ...
                <p>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  Quibusdam quae natus quasi voluptas eius minus laboriosam!{" "}
                </p>
              </div>
            </div>
          </div>
