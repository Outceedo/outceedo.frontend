  ...
  return (
    <div className="p-6 bg-white space-y-6 left1/4 w-min-screen h-min-screen items-center justify-center">
      ...
      <div className="space-y-2">
        ...
        <p>
          <strong>Strengths:</strong> Excellent technical skills, strong
          tactical awareness, and great physical attributes. Showed impressive
          (e.g., passing, dribbling, finishing).
        </p>
        <p>
          <strong>Areas for Improvement:</strong> Needs more consistency, better
          decision-making under pressure, and improved (e.g., defensive
          transitions, off-the-ball movement).
        </p>
        <p>
          <strong>Verdict:</strong> A promising player with great potential.
          With refinement in key areas, they can excel in their role.
        </p>
      </div>
    </div>
  );
